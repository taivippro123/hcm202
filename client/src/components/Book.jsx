...
const Page = ({ number, front, back, page, opened, bookClosed, ...props }) => {
  ...
  useFrame((_, delta) => {
    ...
    // Disable emissive highlight to remove page glow
    if (skinnedMeshRef.current.material[4]?.emissiveIntensity !== undefined) {
      skinnedMeshRef.current.material[4].emissiveIntensity = 0;
    }
    if (skinnedMeshRef.current.material[5]?.emissiveIntensity !== undefined) {
